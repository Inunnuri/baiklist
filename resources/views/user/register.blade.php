<header class="relative bg-headerRegister bg-center bg-cover min-h-[350px] flex items-center justify-center">
    ...
    <div class="flex flex-col items-center justify-center px-6 mx-auto">
        <div class="w-full bg-white rounded-lg shadow-lg m-2 dark:border max-w-md dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6">
                ...
                <form class="space-y-4" method="POST" action="{{ url('register/submit') }}">
                    @csrf
                    <div>
